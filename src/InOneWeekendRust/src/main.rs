...
fn main() {
	...
	let [viewport_u, viewport_v] = [
		glam::vec3(viewport_size.x, 0., 0.),
		glam::vec3(0., -viewport_size.y, 0.),
	];
	// Calculate the horizontal and vertical delta vectors from pixel to pixel.
	let [pixel_delta_u, pixel_delta_v] = [
		viewport_u / image_width as f32,
		viewport_v / image_height as f32,
	];
	// Calculate the location of the upper left pixel
	let viewport_upper_left =
		camera_center - glam::vec3(0., 0., focal_length) - viewport_u / 2. - viewport_v / 2.;
